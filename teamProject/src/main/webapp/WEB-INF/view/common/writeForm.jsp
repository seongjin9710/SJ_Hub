	...
	<div align="center">
		...
		<form action="write.do" method="post">
			<table>
				...
				<tr height="85%">
					<td class="aa">내용</td>
					<td colspan="3"><textarea name="boardContent" id="editor" wrap="hard"></textarea>
						<script>
						    ClassicEditor
			...
			<input type="hidden" name="mainNum" value="${side.mainNum }">
			<input type="hidden" name="sideNum" value="${side.sideNum }">
			<input type="hidden" name="sideDetailNum" value="${side.sideDetailNum }">
			<div style="height: 40px;"></div>
