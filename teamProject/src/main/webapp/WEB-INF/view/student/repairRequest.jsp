...
<div style="width: 100%;" align="center">
	<table>
		...
		<thead>
			<tr>
				<td class="title4">번호</td>
				<td class="title4">제목</td>
				<td class="title4">작성자</td>
				<td class="title4">신청일</td>
				<td class="title4">처리상태</td>
				<td class="title4">조회</td>
			</tr>
		</thead>
		<tbody>
...
<div style="width: 100%; margin-top: 30px;" align="center">
	<input type="button" value="글쓰기" onclick="location.href='repairRequestForm.do?mainNum=5&sideNum=14';">
</div>
</body>
</html>