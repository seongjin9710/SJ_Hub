...
<div style="height: auto; width: 100%;">
	...
	<div style="width: 90%;" align="center"><p style="color: red">*학생의 이름을 클릭하면 학사경고 페이지가 열립니다.</p></div>
		...
		<table>
			...
			<c:forEach items="${studentList }" var="stu">
				<tr>
					...
					<td>${stu.depName }</td>
					<td class="probationCnt">${stu.probationCnt }<input type="hidden" class="memEmail" value="${stu.memEmail }"></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
...
<script type="text/javascript" src="resources/js/probationPage.js?ver=581"></script>
</body>
</html>