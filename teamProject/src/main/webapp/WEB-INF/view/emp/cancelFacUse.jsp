		...
		<table id="resultTable">
			...
			<c:forEach items="${useList }" var="facUse">
				<tr>
					...
					<td>${facUse.ttStartTime.substring(0, 2)} : ${facUse.ttStartTime.substring(2, 4)} ~ 
						${facUse.ttEndTime.substring(0, 2)} : ${facUse.ttEndTime.substring(2, 4)}
					</td>
					<td>${facUse.memId }</td>
...
<script src="resources/js/cancelFacUse.js?ver=4555"></script>
</body>
</html>