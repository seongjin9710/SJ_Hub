...
<div style="height: auto; width: 100%;">
	...
	<div style="width: 90%;" align="center">
		<p style="color: red">*학생의 이름을 클릭하면 학생 제적 페이지가 열립니다.</p>
		<p>*학사경고 횟수가 3회를 넘은 학생은 빨간 색으로 표시됩니다.</p>
	</div>
	<div style="height: 600px; width: 90%; overflow: scroll; border-bottom: 2px solid #191970;" align="center" class="listTable">
		<table>
			<colgroup>
				<col width="15%">
				<col width="10%">
			...
			<c:forEach items="${studentList }" var="stu">
				<tr >
					<td>${stu.stuNum }</td>
					<td>${stu.stuYear }</td>
					<td><span class="openModal">${stu.stuName }</span></td>
					<td>${stu.collegeName }</td>
					<td>${stu.depName }</td>
					<td class="probationCnt">${stu.probationCnt }회<input type="hidden" class="memEmail" value="${stu.memEmail }"><input type="hidden" class="studentStatus" value="${stu.memStatus }"></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
...
<script type="text/javascript" src="resources/js/expelPage.js?ver=7"></script>
</body>
</html>