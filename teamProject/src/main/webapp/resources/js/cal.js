...
$(document).ready(function(){
	...
	$(document).on('click', '.fc-next-button', function() {
		var calcal11 = $('.fc-toolbar-title').text();
		var calYear11 = calcal11.substring(0,4);
		var calMonth11 = calcal11.substring(6,8);
		var calTYM11 = calYear11+calMonth11;
		...
		//Ajax 시작
	      $.ajax({
	            ...
	            type: 'post',
	            async: false,
	            data: {'calStartDate' :calTYM11}, //요청경로로 던질 파라메터. '파레메터명':파라메터
