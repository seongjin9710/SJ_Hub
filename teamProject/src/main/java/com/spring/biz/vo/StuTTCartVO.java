...
public class StuTTCartVO {
	// PK용 
    private int stuTtCartNum;
    // 학생번호 
    private int stuNum;
    // 강의코드 
    ...
    public int getStuTtCartNum() {
		return stuTtCartNum;
	}
	public void setStuTtCartNum(int stuTtCartNum) {
		this.stuTtCartNum = stuTtCartNum;
	}
	...
	public String toString() {
		return "StuTTCartVO [stuTtCartNum=" + stuTtCartNum + ", stuNum=" + stuNum + ", lecTtCode=" + lecTtCode
				+ ", lecTimeList=" + lecTimeList + ", depName=" + depName + ", collegeName=" + collegeName
				+ ", lectureName=" + lectureName + ", lecCredit=" + lecCredit + ", recYear=" + recYear + ", profName="
				+ profName + ", semCode=" + semCode + "]";
	}
