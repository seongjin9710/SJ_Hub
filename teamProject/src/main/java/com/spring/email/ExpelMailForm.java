...
public class ExpelMailForm {
	private String text;
	
	public ExpelMailForm(MemberVO memberVO, ExpelVO expelVO){
		text = "<body class=\"clean-body\" style=\"margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f9f9f9\">\r\n" + 
				...
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 제적일자: "+  expelVO.getExpelDate() +
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 제적 사유: "+ expelVO.getExpelReason()+"</span></li>\r\n" + 
				"</ul>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\">&nbsp;</p>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\">&nbsp;</p>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\"><span style=\"color: #666666; font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: red; font-weight: bold;\">제적처리된 학생은 재입학이 불가능함을 알려드립니다.</span></span></p>\r\n" + 
