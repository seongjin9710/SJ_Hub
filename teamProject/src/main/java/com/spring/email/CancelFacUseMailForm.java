...
public class CancelFacUseMailForm {
	private String text;
	
	public CancelFacUseMailForm(MemberVO memberVO, FacUseListVO facUseListVO) {
		setText("<body class=\"clean-body\" style=\"margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f9f9f9\">\r\n" + 
				...
				"<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #666666;\">다음과 같은 이유로 아래의 시설 사용 예약이 취소되었음을 </span></p>\r\n" + 
				"<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #666666;\">알려드립니다.</span></p>\r\n" + 
				"<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\r\n" + 
				"<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\r\n" + 
				"<ul>\r\n" + 
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 신청번호: "+ facUseListVO.getFacUseNum() +"</span></li>\r\n" + 
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 신청자: "+ memberVO.getMemName() + " (" + memberVO.getMemId() + ")</span></li>\r\n" + 
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 시설명: "+ facUseListVO.getFacName() +"</span></li>\r\n" + 
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; 사용일시: "+ facUseListVO.getFacUseDay() +"</span></li>\r\n" + 
				"<li dir=\"ltr\" style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #000000;\">&nbsp; &nbsp;취소 사유: "+ facUseListVO.getCacelReason() +"</span></li>\r\n" + 
				"</ul>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\">&nbsp;</p>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\">&nbsp;</p>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\"><span style=\"color: #666666; font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px;\">시설 이용에 불편함을 드려 죄송합니다.</span></span></p>\r\n" + 
				...
				"<p style=\"line-height: 140%; font-size: 14px;\">&nbsp;</p>\r\n" + 
				"<p style=\"line-height: 140%; font-size: 14px;\"><span style=\"font-size: 18px; color: #666666; line-height: 25.2px;\">KH대학교 시설관리과(052-214-5248)</span></p>\r\n" + 
				"<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\r\n" + 
				"<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\r\n" + 
				"  </div>\r\n" + 
				"\r\n" + 
				...
				"<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 14px; line-height: 19.6px; color: #ecf0f1;\">KH대학교 시설관리과</span></p>\r\n" + 
				...
				"          <img src=\"cid:image-2.png.png\" alt=\"Instagram\" title=\"Instagram\" width=\"32\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important\">\r\n" + 
				"        </a>\r\n" + 
				"      </td></tr>\r\n" + 
				"    </tbody></table>\r\n" + 
				"    <!--[if (mso)|(IE)]></td><![endif]-->\r\n" + 
